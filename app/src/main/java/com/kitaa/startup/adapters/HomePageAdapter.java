...
public class HomePageAdapter extends RecyclerView.Adapter
{
    ...
    public class StripAdViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.slider_background)).into(_stripAdImage);
        }
    }
    ...
    private class GridProductViewHolder extends RecyclerView.ViewHolder
    {
        ...
        private void setGridProductLayout(final String title, final List<HorizontalScrollProductModel> horizontalScrollProductModelList)
        {
            ...
            for(int x = 0; x < 4; x++)
            {
                ...
                Glide.with(itemView.getContext()).load(horizontalScrollProductModelList.get(x).getProductPhoto()).apply(new RequestOptions().placeholder(R.drawable.slider_background)).into(productImage);
